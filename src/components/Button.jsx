...
const buttonVariants = cva(
  'relative border-none inline-flex items-center justify-center rounded-md overflow-hidden transition-colors focus:outline-none cursor-pointer font-medium drop-shadow-md',
  {
    variants: {
      color: {
